...
type UpdateReleaseRequest struct {
	...
	// Secrets
	Secrets *hapi_chart.Config `protobuf:"bytes,12,opt,name=secrets" json:"secrets,omitempty"`
}
...
func (m *UpdateReleaseRequest) GetSecrets() *hapi_chart.Config {
	if m != nil {
		return m.Secrets
	}
	return nil
...
type InstallReleaseRequest struct {
	...
	// before marking the release as successful. It will wait for as long as timeout
	Wait bool `protobuf:"varint,9,opt,name=wait" json:"wait,omitempty"`
	// Secrets is a string containing (unparsed) YAML secrets.
	Secrets *hapi_chart.Config `protobuf:"bytes,10,opt,name=secrets" json:"secrets,omitempty"`
}
...
func (m *InstallReleaseRequest) GetSecrets() *hapi_chart.Config {
	if m != nil {
		return m.Secrets
	}
	return nil
...
var fileDescriptor0 = []byte{
	...
	,
}
